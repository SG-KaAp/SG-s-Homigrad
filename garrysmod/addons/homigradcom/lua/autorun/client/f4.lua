if CLIENT then
    ...
    local function OpenF4Menu()
        ...
        AddNodeWithIcon(innerFolder, "ddos", "rat.png")
        ...
        AddNodeWithIcon(tree, "sandbox", "sandbox.png")
        ...
        function tree:OnNodeSelected(node)
            ...
            if isFolder then
                ...
                elseif selectedMode == "css" then
                    ...
                    description:SetTextColor(Color(255, 255, 255))
                elseif selectedMode == "ddos" then
                    description:SetText("Дудос Homigrad.com: TDM Режим команда Шарика против команды SadSalat.")
                    description:SetTextColor(Color(255, 255, 255))
                ...
                elseif selectedMode == "riot" then
                    ...
                    description:SetTextColor(Color(255, 255, 255))
                elseif selectedMode == "lizardsmustdie" then
                ...
                elseif selectedMode == "hideandseek" then
                    description:SetText("Режим прятки, где на 4 прячущихся приходится 1 искатель. Через время, если искатели не убили всех прячущихся приезжает спецназ. (Скуллшутинг)")
                    description:SetTextColor(Color(255, 255, 255))
...
if LocalPlayer():IsAdmin() then
    ...
    adminLabel:SetText("Пошел нахуй, ты не ОООООДМЭН")
end
