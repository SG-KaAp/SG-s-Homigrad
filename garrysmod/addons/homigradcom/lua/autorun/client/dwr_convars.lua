...
CreateConVar("cl_dwr_volume", "65", {FCVAR_ARCHIVE}, "Global volume multiplier", 0, 100)
...
CreateConVar("cl_dwr_occlusion_rays", "0", {FCVAR_ARCHIVE}, "Amount of traces ran from the player to the sound source in order to determine the effects")
