...
SWEP.Instructions			= "Представляет собой внутрикурковое двуствольное ружьё с горизонтальным расположением стволов. Калибр: 12/70"
SWEP.Category 				= "SG's Homigrad | Дробовики"
