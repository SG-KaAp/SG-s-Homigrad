if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "vgui/hud/weapon_insurgencykabar" )
SWEP.DrawWeaponInfoBox	= false
SWEP.BounceWeaponIcon = false 
killicon.Add( "weapon_insurgencykabar", "vgui/hud/weapon_insurgencykabar", Color( 0, 0, 0, 255 ) )
end
...
SWEP.ViewModel = "models/weapons/insurgency/v_marinebayonet.mdl"
