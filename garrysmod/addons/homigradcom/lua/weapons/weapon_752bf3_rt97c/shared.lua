...
if ( CLIENT ) then
	...
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon 		= surface.GetTextureID("HUD/killicons/RT97C")
	
	killicon.Add( "weapon_752bf3_rt97c", "HUD/killicons/RT97C", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/synbf3/v_RT97C.mdl"
...
local FireSound 			= Sound ("weapons/synbf3/RT97C_fire.wav");
local ReloadSound			= Sound ("weapons/synbf3/RT97C_reload.wav");
