...
if ( CLIENT ) then
	...
	killicon.Add( "npc_sw_weapon_752_kyd21", "HUD/killicons/KYD21", Color( 255, 80, 0, 255 ) )
...
function SWEP:PrimaryAttack()
	...
	// In singleplayer this funpction doesn't get called on the client, so we use a networked float
