...
if ( CLIENT ) then
	...
	killicon.Add( "npc_sw_weapon_752_elg3a", "HUD/killicons/ELG3A", Color( 255, 80, 0, 255 ) )
...
function SWEP:PrimaryAttack()
	...
	// In singleplayer this funct[ion doesn't get called on the client, so we use a networked float
