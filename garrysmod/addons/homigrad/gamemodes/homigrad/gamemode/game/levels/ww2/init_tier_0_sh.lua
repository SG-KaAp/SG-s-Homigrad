...
ww2.blue = {"Вермахт",Color(125,125,255),
	weapons = {"megamedkit","weapon_binokle","weapon_hands","weapon_kabar","med_band_small","med_band_big", "weapon_hg_stielhandgranate24", "med_band_small", "medkit", "weapon_hg_crowbar", "sieghail" },
