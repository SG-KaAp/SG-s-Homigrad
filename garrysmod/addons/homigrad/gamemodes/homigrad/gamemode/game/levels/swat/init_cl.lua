...
function swat.Scoreboard_Status(ply)
...
function swat.HUDPaint_RoundLeft(white2,time)
	...
	*/
	...
	if lply:Team() == 3 or lply:Team() == 2 or not lply:Alive() and swat.police then
...
function swat.PlayerClientSpawn()
